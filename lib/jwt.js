...
// https://github.com/michaelrhanson/jwt-js/ and adapted for use in node.js.
...
var ASCII_ENCODING = 'binary';

var window = {
  // https://github.com/coolaj86/node-browser-compat/blob/master/btoa/index.js
  btoa: function btoa(str) {
    var a = new Buffer(str, ASCII_ENCODING).toString('base64');
    return a;
  },
  atob: function atob(str) {
    var b= new Buffer(str, 'base64').toString(ASCII_ENCODING);
    return b;
  }
};
